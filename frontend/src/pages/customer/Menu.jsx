  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-10">
        <div>
          <h1 className="text-3xl font-extrabold text-gray-700 text-shadow-sm mb-2 small-font">Our Menu</h1>
          <p className="text-gray-500 small-font">Discover fresh, delicious meals carefully crafted for you.</p>
        </div>
        ...
        <div className="relative w-full md:w-96 shadow-sm rounded-2xl">
          ...
          <input
            ...
            className="w-full s pl-12 pr-4 py-3 bg-white border border-gray-200 rounded-2xl focus:ring-2 focus:ring-orange-500 outline-none transition-all"
      ...
      {filteredFoods.length > 0 ? (
            ...
            <div key={food.id} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
              ...
              <div className="relative h-48 w-full bg-gray-100 overflow-hidden group">
                ...
                <div className="absolute top-4 left-4">
                  <span className="bg-white/90 small-font backdrop-blur text-orange-600 px-3 py-1 text-xs font-bold rounded-full shadow-sm">
                    {food.category_name}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6 flex-1 flex flex-col">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-xl small-font font-bold text-gray-900 truncate pr-4" title={food.food_name}>
                    {food.food_name}
                  </h3>
                  <span className="text-lg font-bold text-orange-600 shrink-0 small-font">
                    Rs. {Number(food.price).toFixed(2)}
                  </span>
                </div>

                {/* Description Tooltip / Text */}
                <p className="text-sm text-gray-500 mb-4 line-clamp-2 small-font" title={food.ingredients}>
        ...
        <div className="text-center py-20 bg-gray-50 rounded-3xl border border-dashed border-gray-200">
          <p className="text-gray-500 text-lg small-font">No menu items match your search.</p>
        </div>
      )}
          ...
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="relative h-32 bg-orange-100">
              ...
              <div className="absolute bottom-4 left-6 text-white">
                <h3 className="text-xl font-bold truncate small-font">{selectedFood.food_name}</h3>
                <p className="font-semibold text-orange-400 small-font">Rs. {Number(selectedFood.price).toFixed(2)}</p>
              </div>
            </div>
            ...
            <form onSubmit={handleOrderSubmit} className="p-6">
              <div className="mb-6 bg-blue-50 p-4 rounded-xl flex items-start gap-3 border border-blue-100">
                ...
                <p className="text-sm text-blue-800 small-font">
                  You are about to place an order. You can cancel it later from your dashboard as long as the status remains 'Pending'.
                </p>
              </div>

              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 mb-2 small-font">Quantity</label>
                <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    className="w-10 small-font h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-gray-200 font-bold text-lg transition-colors"
                  >
                    +
                  </button>
                </div>
                {quantity === selectedFood.quantity && (
                  <p className="text-xs text-orange-500 mt-2 font-medium small-font">Maximum available quantity reached.</p>
                )}
              </div>

              <div className="border-t border-gray-100 pt-4 mb-8 flex justify-between items-center">
                <span className="text-gray-500 font-medium small-font">Total Price:</span>
                <span className="text-3xl font-bold text-gray-900 small-font">
              ...
              <div className="flex justify-end gap-3">
                <button
                  ...
                  className="w-full small-font py-3 text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors font-medium"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="w-full small-font py-3 text-white bg-orange-500 hover:bg-orange-600 rounded-xl transition-colors font-bold disabled:opacity-70 shadow-lg shadow-orange-500/30"
                >
